...
description:
  minimaxir's Python code-quality guidelines — fully-optimized code, descriptive
  naming, type hints, docstrings, pytest, and modern tooling (uv, ruff, mypy).
  Use as a reference standard when writing or reviewing Python. In this repository
  dignified-python governs on any conflict.
---
